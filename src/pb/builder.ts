...
// ref: https://github.com/aliyun/aliyun-tablestore-nodejs-sdk/blob/17fbd4469f59aba86d2eba51cfd099d03a39e84b/lib/protocol/tablestore.proto
const tablestoreProto = `
syntax = "proto2";
...
export const builder = proto.parse(tablestoreProto).root;

export const builderFilter = proto.parse(tablestoreFilterProto).root;
